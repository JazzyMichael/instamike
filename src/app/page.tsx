export default function Home() {
  return (
    <div className="p-12">
      <div>
        Outline: About Me, Why Silicon Valley, Why Meta, How this was made
      </div>
      {/* 
      <br />
      ...
      <div>
        ...
        shaping the future of software—people who challenge and inspire each
        other, where excellence is not just encouraged but expected. Silicon
        Valley is where growth tracks for individual contributors are strongest,
        and where the quality of software, tools, and innovation is second to
        none.
      </div>
      ...
      <div>
        ...
        2025, the coding aspect of our jobs should be the easy part. High-impact
        engineers operate closest to the product, shaping direction, analyzing
        tech and user feedback, and iterating rapidly to unlock scale and
        leverage. That mindset resonates deeply with me.
      </div> */}
    </div>
  );
}
